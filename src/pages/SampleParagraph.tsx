      ...
      <div className="w-full max-w-4xl">
        <Card className="border-2 border bg-card text-card-foreground">
          ...
          <div className="px-8 pb-6">
            ...
            <div className="bg-muted border-2 border rounded p-6 mb-8">
              ...
              <div className="space-y-3 text-2xl">
                ...
                <p>
                  After you finish reading, you will answer some questions about
                  what you read.
                </p>
              </div>
            </div>
          ...
          <CardContent className="px-8 py-8">
            ...
            {/* Reading Paragraph */}
            {showParagraph && (
              <div className="bg-card border-2 border rounded p-8 mb-8">
                <p className="text-2xl leading-loose text-center font-medium">
                  The puppy ran in the yard. It saw a cat! The dog barked at the
                  cat.
                </p>
              </div>
            )}
